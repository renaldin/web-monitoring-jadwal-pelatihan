	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/img-01.jpg');">
			<div class="wrap-login100 p-t-0 p-b-30">
                    ...
                    <span class="text-danger mt-2"><?= isset($validation) ? display_error($validation, 'nama') : '' ?></span>
                    ...
                    <span class="text-danger mt-2"><?= isset($validation) ? display_error($validation, 'cpassword') : '' ?></span>
					...
					<div class="text-center w-full">
						<a class="txt1" href="<?= site_url('auth') ?>">
